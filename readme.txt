...
For a list of the top web spiders and how to set them up visit [the plugin's page](https://github.com/seojacky/wp-spider-tracker)

== Installation ==

1. Download the zipped file.
2. Extract the zip file and upload all contents from the folder `wp-spider-tracker` to the `/wp-contents/plugins/` folder
...
1. Show/Hide index activity grouped by spider
2. Activate/deactivate, edit, reset activity and delete spiders
3. Coloured percentage bars

== Changelog ==

= 1.0.3 =
* Fixed problem with missing files on previous update
